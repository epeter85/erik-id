...
})(
    {
        ...
        2: [
            function (require, module, exports) {
                ...
                Foundation.Interchange.SPECIAL_QUERIES['retina_small'] =
                ...
                Foundation.Interchange.SPECIAL_QUERIES['retina_medium'] =
                ...
                Foundation.Interchange.SPECIAL_QUERIES['retina_large'] =
                ...
                $(window).load(function () {
                    ...
                    for (var i = 0; i <= projectsArray.length - 1; i++) {
                        preloadArray.push({ name: projectsArray[i].cardImage, sizes: '1', path: 'images/thumbs/', format: '.jpg' });
                    }
                        ...
                        if (event.data.msg === 'detailsBtn') {
                            ...
                            $('.project-details > .copy > .header').append(
                                '<div><span>client: </span>' +
                                    projectsArray[event.target.id].client +
                                    '</div><div><span>agency: </span>' +
                                    projectsArray[event.target.id].agency +
                                    '</div><div><span>platform: </span>' +
                                    projectsArray[event.target.id].platform +
                                    '</div>'
                            );
                            //add description
